...
client.on('guildMemberAdd', member => {
  ...
  const channel = member.guild.channels.find('name', 'yenı-gelenler');
  if (!channel) return;
 ...
 .setFooter('ZodiBot', client.user.avatarURL)
 .setTimestamp()
 channel.send(embed);
});
...
client.on("message", message => {
    const lınk = ["discord.gg", "discord.me", "discordapp.com", "discord.io", "discord.tk"];
